...
function homePage() {
  ...
  function teamSlider() {
    var $carouselGallery = $(".homepage .section-gallery .list"),
    ...
    var ctrPrevGallery = $('.homepage .section-gallery .btn_ctr.prev'),
  ...
  jarallax(); // $('#video-intro').on('load', function () {
  //     frames[0].document.head.appendChild('<style>.ytp-scroll-min{display: none;}</style>');
  // })

  var videoIntroWrap = $('.section-different .videodif'),
  ...
  function loadVideoBG() {
    var videoBgWrap = $('.banner .video-bg'),
...
function courseDetailAccordion() {
  $('.accordion .accordion__title').on('click', function (e) {
    e.preventDefault(); // $(this).closest('.accordion').siblings('.active').removeClass('active')
...
$(document).ready(function () {
  ...
  function testimonialSlider() {
    if ($('.section-testimonial').length) {
      var $carousel = $(".section-testimonial .images .list").flickity({
        ...
        on: {
          ready: function ready() {
            var dotsSlideTes = $('.section-testimonial .flickity-page-dots');
            var dotsNew = $('.section-testimonial .dots');
      ...
      var ctrPrevTes = $('.section-testimonial .btn_ctr.prev'),
